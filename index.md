...
<div class="home">
  ...
  <section class="forge-hero-vaporized">
    ...
    <!-- BRAND STAMP (now matches header glowing animation) -->
    <div class="hero-stamp forge-title">
      M.R. TechForge
    </div>
  ...
  <section class="home-products">
    ...
    <p class="forge-text-gradient">
      M.R. TechForge is actively developing a handful of lightweight, user-friendly tools designed to
      make digital life safer, calmer, and easier.
    </p>

    <ul>
      <li class="forge-text-gradient"><strong>ForgeDrive:</strong> A clean, organized USB toolkit with utilities & documentation</li>
      <li class="forge-text-gradient"><strong>Forge Tags:</strong> Simple NFC cards for easy, secure information sharing</li>
      <li class="forge-text-gradient"><strong>ForgeSBC:</strong> A Raspberry-Pi powered home hub for ad-blocking, secure access, and syncing</li>
    </ul>

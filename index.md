...
<div class="home">
  ...
  <section class="forge-hero-vaporized">
    ...
    <!-- TOP TAGLINE -->
    <p class="hero-tagline forge-text-gradient-soft">
      Practical, relationship-focused tech consulting for homes, churches, customized tech gadgets, and small businesses.
    </p>

    <!-- BRAND STAMP (uses header glow) -->
    <div class="hero-stamp forge-header-brand-glow">
      M.R. TechForge
    </div>
  ...
  <section class="home-how">
    ...
    <ul class="how-steps">
      <li>
        ...
        <span class="forge-text-gradient-soft">We talk through your needs, challenges, and goals — in plain English.</span>
      </li>

      <li>
        <span class="step-label">2. Plan</span>
        <span class="forge-text-gradient-soft">You get clear, practical options instead of overwhelming complexity.</span>
      </li>

      <li>
        <span class="step-label">3. Build</span>
        <span class="forge-text-gradient-soft">Clean, dependable solutions designed for long-term stability.</span>
      </li>
    </ul>

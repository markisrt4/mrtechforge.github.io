...
<section class="home-audience">
  ...
  <div class="audience-grid">
    ...
    <div class="pillar-card">
      <p class="forge-text-gradient-soft">
        Families needing safer, cleaner digital setups.
      </p>
      <p class="forge-text-gradient-soft">
        Small businesses seeking dependable tech guidance.
      </p>
      <p class="forge-text-gradient-soft">
        Churches wanting trustworthy network or communication help.
      </p>
      <p class="forge-text-gradient-soft">
        Customized tech gadgets needing integration, automation, or secure routing.
      </p>
    </div>

    <div class="pillar-card">
      <p class="forge-text-gradient-soft">
        Professionals needing privacy-focused technical solutions.
      </p>
      <p class="forge-text-gradient-soft">
        Anyone overwhelmed by “big tech” systems and noise.
      </p>
      <p class="forge-text-gradient-soft">
        People wanting simpler, more organized home tech.
      </p>
      <p class="forge-text-gradient-soft">
        Those ready to build better digital habits.
      </p>
    </div>
...
<section class="home-products">
  ...
  <div class="pillar-card">
    ...
    <p class="forge-text-gradient-soft">
      ...
      user-friendly tools designed to make digital life safer, calmer,
      and easier.
    </p>

    <p class="forge-text-gradient-soft">
      <strong>ForgeDrive:</strong> A clean, organized USB toolkit with
      utilities &amp; documentation.
    </p>

    <p class="forge-text-gradient-soft">
      <strong>Forge Tags:</strong> Simple NFC cards for easy, secure
      information sharing.
    </p>

    <p class="forge-text-gradient-soft">
      <strong>ForgeSBC:</strong> A Raspberry-Pi powered home hub for
      ad-blocking, secure access, and syncing.
    </p>

---
layout: default
title: Phone, Voice & Messaging Services
...
<div class="forge-card phone-services-card">
  <p>
    Most people don’t need a giant enterprise phone system — they need something
    <strong>simple, clear, and effective</strong>:
  </p>

  <ul>
    <li>A clean number that isn’t your personal cell</li>
    <li>A helpful “press 1…” menu</li>
    <li>A text line that answers common questions instantly</li>
    <li>A safer number for login codes</li>
    <li>
      Optional secure routing into
      <a href="https://signal.org" target="_blank" rel="noopener">Signal</a>
    </li>
    <li>Tools that save time and reduce stress</li>
  </ul>
...
<div class="pricing-card" id="pricing-business-line">
<h3>Business Line</h3>
...
<div class="pricing-card" id="pricing-church-ministry">
...
<div class="pricing-card" id="pricing-library">
...
<div class="pricing-card" id="pricing-press-1">
...
<div class="pricing-card" id="pricing-auto-reply">
...
<div class="pricing-card" id="pricing-2fa">
...
<div class="pricing-card" id="pricing-privacy-shield">
...
<div class="forge-card phone-services-card">
  <ol class="how-it-works-steps">
    <li><strong>We talk</strong> about how people contact you today.</li>
    <li><strong>You choose a phone number provider</strong> you control.</li>
    <li><strong>I build your system</strong> — menus, routing, alerts, privacy tools.</li>
    <li><strong>We test it together</strong> until it behaves exactly right.</li>
    <li><strong>Ongoing support</strong> keeps your system working as your needs grow.</li>
  </ol>
</div>
